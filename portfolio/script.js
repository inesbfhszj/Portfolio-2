...
contactForm.addEventListener('submit', (e) => {
    ...
    alert(`Merci ${formData.name} ! Votre message a été envoyé. Je vous répondrai bientôt à ${formData.email}.`);
    
    // Réinitialiser le formulaire
    contactForm.reset();
    
    // Note: Dans un vrai projet, vous devriez envoyer ces données à un serveur
    // Exemple avec fetch:
    // fetch('/api/contact', {
    //     method: 'POST',
